...
; 7. Compare ADC value to target
; 8. Show feedback on LEDs
; 9. If player wins, increment score and start next round
; =========================================================
...
MainLoop:
    ...
    CALL DisplayTarget      ; Show target on HEX displays
...
; Hex0 = low nibble (low 4 bits)
; Hex1 = high nibble (high 4 bits)
; =========================================================
DisplayTarget:
    LOAD Target
    AND LowNibbleMask
...
; Displays score on Hex3 as a placeholder.
; =========================================================
IncrementScore:
    LOAD Score
    ADDI 1
...
DoneMask:      DW &H0001    ; Assumes DONE bit is bit 0
...
WinFlag:     DW 0           ; 1 if player wins, and 0 otherwise
